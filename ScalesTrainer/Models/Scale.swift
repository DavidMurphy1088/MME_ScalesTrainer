...
public class ScaleType : ObservableObject, Equatable, Hashable, Identifiable {
    public let idx = UUID()
    ...
    public init(type:ScaleShapeType, ascendingScaleOffsets:[Int], descendingScaleOffsets:([Int]?) = nil) {
        self.type = type
...
public class Scale {
    ...
    public init(key:Key, scaleType:ScaleType, rightHand:Bool) {
        self.key = key
    ...
    public func isMidiInScale(midi:Int) ->Bool {
